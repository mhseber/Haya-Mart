...
import OthobeMo from "../ProductModalPage/OthobeMo";
...
const Othobe = () => {
  ...
  useEffect(() => {
    // fetch("http://localhost:3000/api/items/othobe")
    fetch("ProductData/othobe.json")
      .then((res) => {
  ...
  return (
    <div className="px-6 py-6">
      ...
      <section className=" gap-3 my-8 pl-5">
        <h2 className="text-3xl font-bold text-blue-200"> Omani Thobe</h2>
      </section>
      ...
      {selectedItem && (
        <OthobeMo item={selectedItem} onClose={handleCloseModal} />
      )}
