...
import CapsMo from "../ProductModalPage/CapsMo";
  ...
  return (
    <div className="px-6 py-6">
      ...
      <section className=" gap-3 my-8 pl-5">
        <h2 className="text-3xl font-bold text-blue-200">Docker Cap</h2>
      </section>
      ...
      {selectedItem && (
        <CapsMo item={selectedItem} onClose={handleCloseModal} />
      )}
