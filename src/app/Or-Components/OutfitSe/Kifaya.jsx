...
import KifayaMo from "../ProductModalPage/KifayaMo";
...
const Kifaya = () => {
  ...
  useEffect(() => {
    // fetch("http://localhost:3000/api/items/kifaya")
    fetch("ProductData/kifaya.json")
      .then((res) => {
  ...
  return (
    <div className="px-6 py-6">
      ...
      {selectedItem && (
        <KifayaMo item={selectedItem} onClose={handleCloseModal} />
      )}
